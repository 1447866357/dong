...
class BallOnPlate:
    ...
    def step(self, action, state):
        ...
        self.angleTargets = np.array(action)*240
        ...
        p.setJointMotorControl2(bodyUniqueId=self.plateId, jointIndex=0, controlMode=p.TORQUE_CONTROL,

                                force=self.angleTargets[0], physicsClientId=self.physId)

        p.setJointMotorControl2(bodyUniqueId=self.plateId, jointIndex=1, controlMode=p.TORQUE_CONTROL,

                                force=self.angleTargets[1], physicsClientId=self.physId)
