...
class BallOnPlate:
    ...
    def __init__(self, showGUI=False, randomInitial=False):
        ...
        self.plateId = p.loadURDF(os.path.dirname(os.path.realpath(__file__)) + '/plate_1.urdf',
    ...
    def step(self, action, state):
        ...
        p.setJointMotorControl2(bodyUniqueId=self.plateId, jointIndex=0, controlMode=p.POSITION_CONTROL,
                                ...
                                force=force_max, targetPosition=self.angleTargets[0], physicsClientId=self.physId)

        p.setJointMotorControl2(bodyUniqueId=self.plateId, jointIndex=1, controlMode=p.POSITION_CONTROL,

                                force=force_max, targetPosition=self.angleTargets[1], physicsClientId=self.physId)
